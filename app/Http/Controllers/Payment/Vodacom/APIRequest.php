...
namespace App\Http\Controllers\Payment\Vodacom;
...
include('public/pub/Crypt/RSA.php');
...
class APIRequest extends Controller
{
	...
	function __construct($context) {
		if ($context != null && get_class($context) != 'App\Http\Controllers\Payment\Vodacom\APIContext') {
