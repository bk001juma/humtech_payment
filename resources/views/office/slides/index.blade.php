                                ...
                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-header">
                                            <!--begin::Modal title-->
                                            <h2 class="fw-bold">Create Slide</h2>
                                            <!--end::Modal title-->
                                        ...
                                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                            <!--begin::Form-->
                                            <form method="post" class="form" action="{{route('admin.slides.create')}}" enctype="multipart/form-data">
                                                @csrf
                                                <div class="fv-row mb-10">
                                                    <label class="fs-6 fw-semibold form-label mb-2">Slide Title:</label>
                                                    <input type="text" name="title" data-kt-user-table-filter="search" class="form-control form-control-solid  " placeholder="Title"/>
                                                </div>

                                                <div class="fv-row mb-10">
                                                    <label class="fs-6 fw-semibold form-label mb-2">Description:</label>
                                                    <textarea class="form-control form-control-solid " name="description" cols="5"></textarea>
                                                </div>

                                                <!--begin::Input group-->
                                                <div class="fv-row mb-10">
                                                    <!--begin::Label-->
                                                    <label class="required fs-6 fw-semibold form-label mb-2">Select Slide Image:</label>
                                                    <!--end::Label-->
                    ...
                    <div class="card-body py-4">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                            ...
                            @foreach($slides as $slide)
                                @include('office.slides.includes.slide_table')
                            @endforeach
                            </tbody>
                        </table>
                        <!--end::Table-->
