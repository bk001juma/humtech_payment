    ...
    <div class="page-main-header col">
        ...
        <div class="nav-right">
            <ul class="header-right">
                ...
                <li>  <a class="dark-mode" href="javascript:void(0)"><i class="ic iconly-Star"></i></a>
                </li>

                <li class="custom-dropdown"><a href="javascript:void(0)"> <i class="ic iconly-Notification"></i></a><span class="badge rounded-pill badge-primary">4</span>
                ...
                <li><a class="full-screen" href="javascript:void(0)"><i class="ic icon-fullscreen"></i></a>
                </li>
                    ...
                    <div class="custom-menu overflow-hidden">
                        <ul class="profile-body">
                            ...
                            <li class="d-flex">
                                ...
                                <a class="ms-2" href="{{ route('logout') }}" onclick="event.preventDefault();
