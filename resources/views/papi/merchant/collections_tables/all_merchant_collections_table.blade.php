                ...
                @foreach($business->transactions->where('type','credit') as $transaction)
                    <tr>
                        ...
                        <td class="text-center">
                            <span class="badge rounded-pill @if($transaction->status == 'paid')badge-light-success @elseif($transaction->status == 'pending')badge-light-warning @else badge-light-danger @endif  text-capitalize">{{$transaction->status}}</span></td>
                        <td class="text-center">
