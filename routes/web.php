...
Route::group(['middleware' => ['web', 'checkblocked']], function () {
    ...
    Route::get('/receipt/{id}/qr',[BusinessController::class, 'downloadReceipt'])->name('receipt.download');
...
//    cars
    Route::get('/cars', [WelcomeController::class,'cars'])->name('cars');
    Route::get('/cars/category/{title}', [WelcomeController::class,'cars'])->name('cars.category');
    Route::get('/cars/car/{id}/{title}', [WelcomeController::class,'car'])->name('car');
    Route::get('/contacts', [WelcomeController::class,'contacts'])->name('contacts');

    Route::post('/contacts/send/message', [SMSController::class,'sendSMS'])->name('send.sms');
    Route::post('/contacts/send/booking', [SMSController::class,'bookCar'])->name('send.booking');

//    Blog
    Route::get('/blog', [WelcomeController::class,'blog'])->name('blog');
    Route::get('/blog/post/{id}/{title}', [WelcomeController::class,'post'])->name('blog.post');
});
